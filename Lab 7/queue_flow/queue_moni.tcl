...
proc finish {} {
	...
	{
	    if ($1 == "Q" && NF>2) {
		print $2, $3 >> "temp_q.dat";
		set end $2
	    }
	    else if ($1 == "a" && NF>2)
	    print $2, $3 >> "temp_a.dat";
	}
    }
    if { [info exists tchan_] } {
	close $tchan_
    }
    exec rm -f temp_q.dat temp_a.dat 
    exec touch temp_a.dat temp_q.dat
    
    exec awk $awkCode trace.txt
    exit 0
}
